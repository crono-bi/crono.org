...
![Conexión](/img/conexion.gif)

Vea el artículo sobre [Propiedades de conexión](connection-properties.md) para mayor información.
...
![Cómo crear un diagrama](/img/diagrama.gif)

En el artículo sobre [cómo crear un diagrama](diagram-creation.md) se muestra paso a paso con imágenes explicativas.
...
![image-20200302130450547](/img/catalogo6.png)

En el artículo sobre [cómo crear elementos de negocio](business-items-creation.md) se muestra paso a paso con imágenes explicativas.
...
En el artículo [Validar catálogo](catalog-validation.md) se muestran estas herramientas con imágenes explicativas.
