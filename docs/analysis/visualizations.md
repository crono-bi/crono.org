...
![Tipos Visualización](/img/analysis/TiposVisualizacion.gif)
...
![Tipos Visualización](/img/analysis/TiposVisualizacion2.gif)
...
![Gráfico de 1 indicador](/img/analysis/Grafico1.png)

Si la consulta tiene varios indicadores, entonces debe tener una única dimensión.

![Gráfico de varios indicadores](/img/analysis/Grafico2.png)
...
![Advertencia gráfico](/img/analysis/Grafico3.png)

Por ejemplo, el "velocímetro" solo permite representar un indicador:

![Gráfico velocímetro](/img/analysis/Grafico4.png)
