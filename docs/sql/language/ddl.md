...
<SqlCodeBlock jsonPath="/json_sql/sql-86FFDA.json" />
...
<SqlCodeBlock jsonPath="/json_sql/sql-1AA043.json" />
...
<SqlCodeBlock jsonPath="/json_sql/sql-D6113D.json" />
...
<SqlCodeBlock jsonPath="/json_sql/sql-237D1B.json" />
...
<SqlCodeBlock jsonPath="/json_sql/sql-B63BB2.json" />

En el caso de los procedimientos "anónimos" se debe utilizar **EXECUTE LOAD** (o **EXEC LOAD**):

<SqlCodeBlock jsonPath="/json_sql/sql-A47EBA.json" />
...
<SqlCodeBlock jsonPath="/json_sql/sql-7DB008.json" />
...
<SqlCodeBlock jsonPath="/json_sql/sql-24A6FD.json" />
...
<SqlCodeBlock jsonPath="/json_sql/sql-D56D97.json" />


Para eliminar una vista existente se puede utilizar **DROP VIEW** o **DROP VIEW IF EXISTS**

<SqlCodeBlock jsonPath="/json_sql/sql-CC7D3D.json" />
...
<SqlCodeBlock jsonPath="/json_sql/sql-E06AE4.json" />
