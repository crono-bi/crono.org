...
<CrossTable
  columns={['Modificador', 'KEY<br/>obligatoria', 'FECHA<br/>INSERT', 'FECHA<br/>UPDATE', 'FECHA<br/>DELETE', 'FECHA<br/>START', 'FECHA<br/>END']}
  rows={[
    { label: 'MERGE CLONE',       cells: ['yes', 'x',  'x',  'dash', '',   ''  ] },
    { label: 'MERGE HISTORY',     cells: ['yes', '',   '',   '',     'x',  'x' ] },
    { label: 'MERGE SOFT DELETE', cells: ['yes', 'x',  'x',  'x',   '',   ''  ] },
    { label: 'MERGE UPSERT',      cells: ['yes', 'x',  'x',  '',    '',   ''  ] },
    { label: 'INSERT OVERWRITE',  cells: ['no',  'x',  '',   '',    '',   ''  ] },
    { label: 'INSERT IF NEW',     cells: ['yes', 'x',  '',   '',    '',   ''  ] },
    { label: 'INSERT RAW',        cells: ['nokey','x', '',   '',    '',   ''  ] },
    { label: 'UPDATE',            cells: ['yes', '',   'x',  '',    '',   ''  ] },
    { label: 'DELETE',            cells: ['yes', '',   '',   'dash','',   ''  ] },
  ]}
/>
