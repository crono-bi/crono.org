...
![Tipos de filtro](/img/analysis/filtros.png)
...
![Filtro de columna](/img/analysis/crearfiltrocolumna.gif)
...
![Arrastrar filtros](/img/analysis/FiltrarDesdeConsulta.png)

## Modificar un filtro

Una vez creado el filtro se puede eliminar o modificar sus características desde el menú contextual:

![Arrastrar filtros](/img/analysis/MenuContextualFiltro.png)
...
![Propiedades de filtro](/img/analysis/PropiedadesFiltro.png)
...
![Operadores avanzados](/img/analysis/OperadoresAvanzados.png)
...
![Filtro mediante fórmula](/img/analysis/FormulaAvanzada.png)
